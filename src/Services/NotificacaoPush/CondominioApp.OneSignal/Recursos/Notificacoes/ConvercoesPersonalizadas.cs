...
{
    #region ConversorPersonalizadoDeDateTime
    
    public class ConversorPersonalizadoDeDateTime : IsoDateTimeConverter
    {
        /// <summary>
        /// Default constructor.
        /// </summary>
        public ConversorPersonalizadoDeDateTime()
        {
    ...
    #region ConversorDeOptionJsonAtrasado
    
    public class ConversorJsonDeOpcaoAtrasado : StringEnumConverter
    {        
        ...
        {
            return objectType == typeof(ConversorJsonDeOpcaoAtrasado);
        }
    }
    ...
    #region ConversorDeCampoDeFiltroDeTipoDeNotificacao

    public class ConversorDeCampoDeFiltroDeTipoDeNotificacao : StringEnumConverter
    {       
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            bool isNullable = (Nullable.GetUnderlyingType(objectType) != null);
        ...
        public override bool CanConvert(Type objectType)
        {
            return objectType == typeof(ConversorDeCampoDeFiltroDeTipoDeNotificacao);
        }
    }
    ...
    #region ConversorJasonDeUnixDateTime
    
    public class ConversorJasonDeUnixDateTime : StringEnumConverter
    {        
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            bool isNullable = (Nullable.GetUnderlyingType(objectType) != null);
