...
namespace CondominioApp.OneSignal.Recursos.Notificacoes.Enuns
{    
    public enum VisibilidadeAndroid
    {
        /// <summary>
    ...
    /// </summary>
    public enum CampoTipoDeFiltroDeNotificacao
    {
        /// <summary>
        /// relation = "&gt;" or "&lt;"<br/>
