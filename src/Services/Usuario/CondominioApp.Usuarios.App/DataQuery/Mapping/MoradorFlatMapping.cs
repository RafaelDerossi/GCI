...
{
    public class MoradorFlatMapping : IEntityTypeConfiguration<MoradorFlat>
    {
        public void Configure(EntityTypeBuilder<MoradorFlat> builder)
        {
            builder.HasKey(u => u.Id);

            builder.ToTable("MoradoresFlat");
