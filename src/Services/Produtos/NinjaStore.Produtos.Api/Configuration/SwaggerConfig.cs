    ...
    public static class SwaggerConfig
    {
        public static IServiceCollection AddSwaggerConfiguration(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "NinjaStore Produto API 1.0",
                    Description = "Esta api expõe os recursos do sistema NinjaStore relacionados a produto para diversas interfaces (web/mobile).",
