    ...
    public class ViewModelToEntityLoja : Profile
    {
        public ViewModelToEntityLoja()
        {
            ...
            CreateMap<CampanhaNovaViewModel, Campanha>()
                .ConstructUsing(campanha => new Campanha(campanha.Titulo, campanha.Descricao, campanha.Banner, campanha.DataDeInicio, campanha.DataDeFim, campanha.TodosOsCondominios, campanha.ItemDeVendaId));
