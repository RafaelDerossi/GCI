...
namespace CondominioAppMarketplace.Infra.Migrations
{
    ...
    [Migration("20200310132016_CamposDeContatoDoParceiro")]
    partial class CamposDeContatoDoParceiro
    {
            ...
            modelBuilder.Entity("CondominioApp.Loja.Domain.Parceiro", b =>
                {
                    ...
                    b.OwnsOne("CondominioApp.Loja.Core.ValueObjects.Telefone", "TelefoneCelular", b1 =>
                        {
                            b1.Property<Guid>("ParceiroId")
                                .HasColumnType("uniqueidentifier");
