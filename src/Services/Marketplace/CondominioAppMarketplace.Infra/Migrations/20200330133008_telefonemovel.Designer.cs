...
namespace CondominioAppMarketplace.Infra.Migrations
{
    ...
    [Migration("20200330133008_telefonemovel")]
    partial class telefonemovel
    {
            ...
            modelBuilder.Entity("CondominioApp.Loja.Domain.Lead", b =>
                {
                    ...
                    b.OwnsOne("CondominioApp.Loja.Core.ValueObjects.TelefoneMovel", "Telefone", b1 =>
                        {
                            b1.Property<Guid>("LeadId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CondominioApp.Loja.Domain.Parceiro", b =>
                {
                    ...
                    b.OwnsOne("CondominioApp.Loja.Core.ValueObjects.Telefone", "TelefoneFixo", b1 =>
                        {
                            b1.Property<Guid>("ParceiroId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("CondominioApp.Loja.Core.ValueObjects.TelefoneMovel", "TelefoneCelular", b1 =>
                        {
                            b1.Property<Guid>("ParceiroId")
                                .HasColumnType("uniqueidentifier");
