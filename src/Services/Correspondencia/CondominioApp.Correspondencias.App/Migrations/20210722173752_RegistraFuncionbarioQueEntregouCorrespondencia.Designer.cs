...
namespace CondominioApp.Correspondencias.App.Migrations
{
    ...
    [Migration("20210722173752_RegistraFuncionbarioQueEntregouCorrespondencia")]
    partial class RegistraFuncionbarioQueEntregouCorrespondencia
    {
            ...
            modelBuilder.Entity("CondominioApp.Correspondencias.App.Models.Correspondencia", b =>
                {
                    ...
                    b.Property<Guid>("CadastradaPorId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CadastradaPorNome")
                        .HasColumnType("varchar(200)");
                    ...
                    b.Property<Guid>("EntreguePorId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("EntreguePorNome")
                        .HasColumnType("varchar(200)");
                    ...
                    b.HasIndex("CodigoDeVerificacao")
                        .IsUnique()
                        .HasFilter("[CodigoDeVerificacao] IS NOT NULL");
