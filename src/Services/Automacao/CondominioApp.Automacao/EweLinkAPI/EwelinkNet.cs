...
using CondominioApp.Automacao.EwelinkNet.Classes;
using CondominioApp.Automacao.EwelinkNet.Helpers.Extensions;
using System.Dynamic;
using CondominioApp.Automacao.EwelinkNet.Payloads;
using CondominioApp.Automacao.EwelinkNet.API.Responses;
using Mapster;
using CondominioApp.Automacao.EwelinkNet.Classes.Events;
using WebSocketSharp;
using System.Linq;

namespace CondominioApp.Automacao.EwelinkNet
{
