    ...
    public class EntityToViewModelUsuario : Profile
    {
        public EntityToViewModelUsuario()
        {
            CreateMap<Usuario, UsuarioViewModel>()
                ...
                .ForMember(c => c.TpUsuario, p => p.MapFrom(x => x.TpUsuario.ToString()))
                .ForMember(c => c.Permissao, p => p.MapFrom(x => x.Permissao.ToString()))
                .ForMember(c => c.Ativo, p => p.MapFrom(x => x.Ativo))
                .ForMember(c => c.Atribuicao, p => p.MapFrom(x => x.Atribuicao))
                .ForMember(c => c.Funcao, p => p.MapFrom(x => x.Funcao))
