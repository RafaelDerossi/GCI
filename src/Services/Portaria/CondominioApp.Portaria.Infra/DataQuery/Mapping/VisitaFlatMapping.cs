   ...
   public class VisitaFlatMapping : IEntityTypeConfiguration<VisitaFlat>
    {
        public void Configure(EntityTypeBuilder<VisitaFlat> builder)
        {
            ...
            builder.Property(u => u.NomeCondomino).IsRequired().HasColumnType($"varchar({VisitaFlat.Max})");
            ...
            builder.Property(u => u.TipoDeDocumentoVisitante).HasColumnType($"varchar({VisitaFlat.Max})");
