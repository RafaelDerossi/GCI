...
namespace CondominioApp.Portaria.Infra.Data
{
    public class PortariaContextDB : DbContext, IUnitOfWorks
    {
        ...
        public PortariaContextDB(DbContextOptions<PortariaContextDB> options, IMediatorHandler mediatorHandler)
            : base(options)
        {
