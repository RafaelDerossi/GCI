...
namespace CondominioApp.Portaria.Infra.Migrations
{
    ...
    [Migration("20210720182326_RetiraCampoQrcode")]
    partial class RetiraCampoQrcode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CondominioApp.Portaria.Domain.Visita", b =>
                {
                    ...
                    b.OwnsOne("CondominioApp.Portaria.Domain.ValueObjects.Email", "EmailVisitante", b1 =>
                        {
                    ...
                    b.OwnsOne("CondominioApp.Portaria.Domain.ValueObjects.Foto", "FotoVisitante", b1 =>
                        {
                            b1.Property<Guid>("VisitaId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("CondominioApp.Portaria.Domain.ValueObjects.Veiculo", "Veiculo", b1 =>
                        {
                            b1.Property<Guid>("VisitaId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CondominioApp.Portaria.Domain.Visitante", b =>
                {
                    b.OwnsOne("CondominioApp.Portaria.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                    ...
                    b.OwnsOne("CondominioApp.Portaria.Domain.ValueObjects.Foto", "Foto", b1 =>
                        {
                            b1.Property<Guid>("VisitanteId")
                                .HasColumnType("uniqueidentifier");
