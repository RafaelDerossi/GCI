   ...
   public class AreaComumCommandTests
    {
        ...
        [Fact(DisplayName = "Adicionar Area Comum Inválido - Periodos Com Horarios Conflitantes")]
        [Trait("Categoria", "Area Comum - CadastrarCommand")]
        public void CadastroDeAreaComum_PeriodoComHorarioConflitante_CommandoInvalido_NaoDevePassarNaValidacao()
        {
            //Arrange
        ...
        [Fact(DisplayName = "Adicionar Area Comum Inválido - Periodos Com Horarios Conflitantes Invertido")]
        [Trait("Categoria", "Area Comum - CadastrarCommand")]
        public void CadastroDeAreaComum_PeriodoComHorarioConflitanteInvertido_CommandoInvalido_NaoDevePassarNaValidacao()
        {
            //Arrange
        ...
        [Fact(DisplayName = "Adicionar Area Comum Inválido - Periodos Com Horarios Conflitantes Pernoite")]
        [Trait("Categoria", "Area Comum - CadastrarCommand")]
        public void CadastroDeAreaComum_PeriodoComHorarioConflitantePernoite_CommandoInvalido_NaoDevePassarNaValidacao()
        {
            //Arrange
        ...
        [Fact(DisplayName = "Adicionar Area Comum Válido - Periodos Validos")]
        [Trait("Categoria", "Area Comum - CadastrarCommand")]
        public void CadastroDeAreaComum_PeriodosValidos_CommandoInvalido_NaoDevePassarNaValidacao()
        {
            //Arrange
        ...
        [Fact(DisplayName = "Adicionar Area Comum Válido - Periodos Pernoite Validos")]
        [Trait("Categoria", "Area Comum - CadastrarCommand")]
        public void CadastroDeAreaComum_PeriodosPernoiteValidos_CommandoInvalido_NaoDevePassarNaValidacao()
        {
            //Arrange
