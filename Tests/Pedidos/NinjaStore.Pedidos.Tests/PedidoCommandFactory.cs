...
namespace NinjaStore.Pedidos.Tests
{
    public class PedidoCommandFactory
    {
        private static AdicionarPedidoCommand AdicionarPedidoCommandFactoy()
        {
            ...
            var produto1 = new ProdutoDTO(Guid.NewGuid(), Guid.NewGuid(), "Produto 1", "foto", 10, 1, 9);
            var produto2 = new ProdutoDTO(Guid.NewGuid(), Guid.NewGuid(), "Produto 2", "foto", 20, 2, 18);
