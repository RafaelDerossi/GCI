...
namespace CondominioApp.Principal.Tests
{
    ...
    {
        public Condominio Criar_Condominio_Valido()
        {           
        ...
        public Condominio Criar_Condominio_Valido_SemFoto()
        {
            var condominio = Criar_Condominio_Valido();
            condominio.SetFoto(new Foto("", ""));
            return condominio;
        }

        
        public Condominio Criar_Condominio_Valido_SemTelefone()
        {
           var condominio = Criar_Condominio_Valido();
        ...
        public Condominio Criar_Condominio_Invalido_SemCNPJ()
        {
            var condominio = Criar_Condominio_Valido();
        ...
        public Condominio Criar_Condominio_Invalido_ComCNPJInvalido()
        {
            var condominio = Criar_Condominio_Valido();
